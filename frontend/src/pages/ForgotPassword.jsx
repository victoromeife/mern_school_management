        ...
        <div className="min-h-screen bg-gray-900 flex items-center justify-center p-4">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="max-w-md w-full">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-surface-600 mt-2">Enter your email and we'll send you a link to reset your password</p>
                </div>
                    ...
                    {!sent ? (
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="text-center">
                                <Link to="/login" className="inline-flex items-center text-sm text-surface-600 hover:text-primary-600 transition-colors">
                        ...
                        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-center space-y-4">
                            ...
                            <h3 className="text-xl font-semibold text-surface-900">Check your email</h3>
                            <p className="text-surface-600">We've sent a password reset link to <strong>{email}</strong></p>
                            <p className="text-sm text-surface-500">Didn't receive the email?{' '}
                                <button onClick={() => {setSent(false); handleSubmit();}} className="text-primary-600 hover:text-primary-700 font-medium">Click to resend</button>
                            </p>
                            <Link to="/login" className="inline-block mt-4 text-primary-600 hover:text-primary-700 font-medium">Return to login</Link>
                        </motion.div>
                    )}
                </Card>
            </motion.div>
